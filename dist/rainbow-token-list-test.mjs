import { z } from 'zod';
import { pick, isPlainObject, mapValues, isString, isEmpty, partition, filter, matchesProperty, map, toLower, mapKeys, unionBy, compact, merge, uniq, some, find, keyBy } from 'lodash-es';
...
var TokenListEnumSchema = /*#__PURE__*/z["enum"](['aave', 'coingecko', 'dharma', 'kleros', 'roll', 'synthetix', 'wrapped']);
...
var TokenExtensionsSchema = /*#__PURE__*/z.object({
  ...
  isRainbowCurated: /*#__PURE__*/z["boolean"]().optional(),
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            overrides = loadFromEndpoint(REMOTE_TOKEN_OVERRIDES_ENDPOINT, fetch, OFFLINE_TOKEN_OVERRIDES);
    ...
    return runtime_1.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            loadedTokens = map(tokenData.tokens, function (token) {
              var rawAddress = token.address,
                  decimals = token.decimals,
                  name = token.name,
                  symbol = token.symbol,
                  extensions = token.extensions;
              var address = toLower(rawAddress);
              return _extends({
                address: address,
                decimals: decimals,
                name: name,
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return loadTokenOverrides(defaultOverrides);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            outputLocation = resolve(location);
            _context2.next = 4;
